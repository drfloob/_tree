...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['_tree', 'underscore', 'test/helper/envDetect.js'], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like enviroments that support module.exports,
        // like Node.
        /* global module, require */
        module.exports = factory(require('_tree'), require('underscore'), require('envDetect'));
    } else {
        // Browser globals (root is window)
        factory(root._tree, root._, root.envDetect);
    }
}(this, function (_tree, _, envD) {

    'use strict';

    describe('immutability tests', function () {

        var ensureTreeImmutability, ensureNodeImmutable, ensureTreeMutability, ensureNodeMutable;
        ...
        if (envD.supportsImmutability()) {
            ...
            // The test environment doesn't support immutability
            ...
            ensureTreeMutability = function (dat) {
                if (Object.isFrozen) {
                ...
                describe('.root()', function () {
                    ...
                    it('can be modified', function () {
                        try { dat.tree.__root = null; } catch(e){}
                        expect(dat.tree.root()).toBeNull();
                        try { dat.tree.__id = null; } catch(e){}
                        expect(dat.tree.__id).toBeNull();
                        try { dat.tree.__nextNodeId = null; } catch(e){}
                        expect(dat.tree.__nextNodeId).toBeNull();
                    });
                });
            };
            ...
            describe('simple _tree.inflate', function () {
                ...
                describe('children', function () {
                    if (Object.isFrozen) {
                        it('is not a frozen array', function () {
                            expect(Object.isFrozen(dat.tree.root().children())).toBe(true);
                        });
                        it('contains one frozen node', function () {
                            expect(Object.isFrozen(dat.tree.root().children()[0])).toBe(true);
            ...
            ensureNodeMutable = function(node) {
                try { node.__tree = null; } catch(e){}
                expect(node.__tree).toBeNull();
                try { node.__data = null; } catch(e){}
